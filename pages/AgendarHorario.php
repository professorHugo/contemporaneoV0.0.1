        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Registrando aula solicitada!</h4>
                </div>
                <div class="modal-body">

                    <?php
                    $ExeQrBuscarPagamentoProfessor = mysql_query("SELECT * FROM professores WHERE nome = '$_POST[professor]'");
